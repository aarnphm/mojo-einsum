...
- **P15** Docs (5 files): `notation.md`, `derivations.md` (BMM lowering, path-cost models, GETT, √K accumulation rule), `perf.md`, `comparisons.md` (vs opt_einsum / JAX / PyTorch / cuTENSOR / TBLIS), `ffi.md` (P5 design-spike).
